...
export const portugueseTextMap = {
  ...
  newResponsibleModal: {
    ...
    inputs: {
      ...
      socialNamePlaceholder: "Digite o nome social do responsável (opcional)",
      cpf: "CPF",
      ...
      nis: "NIS",
      nisPlaceholder: "Digite o NIS do responsável (opcional)",
      phone: "Telefone",
      phonePlaceholder: "Digite o telefone do responsável",
      email: "Email",
      emailPlaceholder: "Digite o email do responsável (opcional)",
      relationship: "Parentesco",
      relationshipPlaceholder: "Digite o parentesco com o educando",
      race: "Raça",
      racePlaceholder: "Selecione a raça (opcional)",
      gender: "Gênero",
      genderPlaceholder: "Selecione o gênero (opcional)",
      educationLevel: "Nível de Escolaridade",
      educationLevelPlaceholder: "Selecione o nível de escolaridade (opcional)",
      socialPrograms: "Programas Sociais",
      socialProgramsPlaceholder: "Selecione os programas sociais (opcional)",
      employmentStatus: "Situação de Emprego",
      employmentStatusPlaceholder: "Selecione a situação de emprego (opcional)",
      street: "Rua",
